...
module.exports = async nono => {
    ...
    nono.commands.forEach(async command => {
    ...
    const rest = new REST({version: "10"}).setToken(nono.token)

    await rest.put(Routes.applicationCommands(nono.user.id), {body: commands})
